$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Изчакайте секунда!</strong> Запазваме Вашите данни.'));

        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            && MD5($('#invite_code').val()) !== '2ac7f43695eb0479d5846bb38eec59cc') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Извиняваме се!</strong> Твоят код за покана е невалиден.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbyo0rEknln8LedEP3bkONsfOh776IR5lFidLhJFQ6jdvRiH4dKvHZmtoIybvnxpxYr2cA/exec', data)
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Извиняваме се!</strong> Има проблем със сървъра. Моля опитайте по-късно. '));
                });
        }
    });
